jQuery(document).ready(function(){
	jQuery('.flexslider').flexslider({directionNav: false, slideshowSpeed: 3000,});
	
	jQuery("#nav").tinyNav({header: 'Menu'});
	
	jQuery('select[name=attribute_pa_size]').select2Buttons();
	jQuery('select[name=attribute_pa_shoe-size]').select2Buttons();
	
	
	jQuery('.select-buttons li a').click(function(){
